...
@section('content')
    ...
    <button onclick="window.location='{{ url("/name") }}'" class="btn btn-block rounded-pill">nom</button>
    <button onclick="window.location='{{ url("/extension") }}'" class="btn btn-block rounded-pill">extention </button>
    <button  class="btn btn-block rounded-pill">Certifiaction</button>
    <button  class="btn btn-block rounded-pill">Illustrateur</button>
    </div>
