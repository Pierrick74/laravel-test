    ...
    <div class="d-flex flex-wrap gap-5 align-items-stretch justify-content-center">
        <div class="card  w-50">
            <div class="card-body">
                ...
                <form class="" action="{{ route('backoffice.product.saveNewProduct') }}" enctype="multipart/form-data" method="post">@csrf
                    ...
                    <div class="d-flex m-1">
                        <label class="card-title w-50 font-weight-bold">Nom du vendeur</label>
                        <input type="text" name="sellerName" id="sellerName" placeholder="nom du vendeur" class="m-0 px-2 w-50 text-right font-weight-bold">
                    </div>
                    <div class="d-flex m-1">
                    ...
                    <div class="d-flex"><button class="btn btn-block mx-4 my-2 px-5"  type="submit">créer</button></div>
                    @if ($errors->any())
